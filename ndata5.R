...
for (i in 1:2000){
  ...
  a[,2]<-100
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 0, 0.5)
...
for (i in 1:2000){
  ...
  a[,2]<-100
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 0, 0.5, 100)
...
for (i in 1:2000){
  ...
  a<-data.gen(c.0,1)
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 1, 0.5)
...
for (i in 1:2000){
  a<-data.gen(c.0,1)
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 1, 0.5, 100)
...
for (i in 1:2000){
  ...
  a<-data.gen(c.0,2)
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 2, 0.5)
...
for (i in 1:2000){
  a<-data.gen(c.0,2)
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 2, 0.5, 100)
...
for (i in 1:2000){
  ...
  a<-data.gen(c.0,3)
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 3, 0.5)
...
for (i in 1:2000){
  a<-data.gen(c.0,3)
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 3, 0.5, 100)
