...
d.k=2
d.r.initial.0=(log(4)^(1/d.k))/d.exp.beta.initial.0
...
k=2
r.initial.0=(log(4))^(1/k)/exp.beta.initial.0
...
for (i in 1:2000){
  ...
  a[,2]<-100
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 0, 0.75)
...
for (i in 1:2000){
  ...
  a[,2]<-100
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 0, 0.75, 100)
    ...
    cover.00[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.00[i] = NA
      b0.is.sd.00[i] = NA
      b1.is.00[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.01[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.01[i] = NA
      b0.is.sd.01[i] = NA
      b1.is.01[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.03[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.03[i] = NA
      b0.is.sd.03[i] = NA
      b1.is.03[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.05[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.05[i] = NA
      b0.is.sd.05[i] = NA
      b1.is.05[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.07[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.07[i] = NA
      b0.is.sd.07[i] = NA
      b1.is.07[i] = NA
...
for (i in 1:2000){
  ...
  a<-data.gen(c.0,1)
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 1, 0.75)
...
for (i in 1:2000){
  a<-data.gen(c.0,1)
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 1, 0.75, 100)
    ...
    cover.10[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.10[i] = NA
      b0.is.sd.10[i] = NA
      b1.is.10[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.11[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.11[i] = NA
      b0.is.sd.11[i] = NA
      b1.is.11[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.13[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.13[i] = NA
      b0.is.sd.13[i] = NA
      b1.is.13[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.15[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.15[i] = NA
      b0.is.sd.15[i] = NA
      b1.is.15[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.17[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.17[i] = NA
      b0.is.sd.17[i] = NA
      b1.is.17[i] = NA
...
for (i in 1:2000){
  ...
  a<-data.gen(c.0,2)
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 2, 0.75)
...
for (i in 1:2000){
  a<-data.gen(c.0,2)
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 2, 0.75, 100)
    ...
    cover.20[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.20[i] = NA
      b0.is.sd.20[i] = NA
      b1.is.20[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.21[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.21[i] = NA
      b0.is.sd.21[i] = NA
      b1.is.21[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.23[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.23[i] = NA
      b0.is.sd.23[i] = NA
      b1.is.23[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.25[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.25[i] = NA
      b0.is.sd.25[i] = NA
      b1.is.25[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.27[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.27[i] = NA
      b0.is.sd.27[i] = NA
      b1.is.27[i] = NA
...
for (i in 1:2000){
  ...
  a<-data.gen(c.0,3)
  tryCatch({
    crq.fit = crq.est(a[,3], 1, a[,6], a[,7], 3, 0.75)
...
for (i in 1:2000){
  a<-data.gen(c.0,3)
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,6], a[,7], 3, 0.75, 100)
    ...
    cover.30[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.30[i] = NA
      b0.is.sd.30[i] = NA
      b1.is.30[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.31[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.31[i] = NA
      b0.is.sd.31[i] = NA
      b1.is.31[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.33[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.33[i] = NA
      b0.is.sd.33[i] = NA
      b1.is.33[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.35[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.35[i] = NA
      b0.is.sd.35[i] = NA
      b1.is.35[i] = NA
...
for (i in 1:2000){
  ...
  tryCatch({
    ...
    cover.37[i,8]=ind(0,ismb.fit[2,1]-1.96*ismb.fit[2,2],ismb.fit[2,1]+1.96*ismb.fit[2,2])}
    , error=function(e){
      b0.is.37[i] = NA
      b0.is.sd.37[i] = NA
      b1.is.37[i] = NA
