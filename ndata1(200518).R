...
for (i in 1:2000){
  ...
  tryCatch({
    rq.fit = rq.est(a[,3], 1, a[,4], a[,5], 0, 0.25)
  ...
  tryCatch({
    ismb.fit = ismbwo.est(a[,3], 1, a[,4], a[,5], 0, 0.25, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 2 : rq with weight
  tryCatch({
    rq.fit = rq.est(a[,3], 1, a[,4], a[,5], 1, 0.25)
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismbwo.est(a[,3], 1, a[,4], a[,5], 1, 0.25, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 2 : rq with weight
  tryCatch({
    rq.fit = rq.est(a[,3], 1, a[,4], a[,5], 2, 0.25)
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismbwo.est(a[,3], 1, a[,4], a[,5], 2, 0.25, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 2 : rq with weight
  tryCatch({
    rq.fit = rq.est(a[,3], 1, a[,4], a[,5], 3, 0.25)
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismbwo.est(a[,3], 1, a[,4], a[,5], 3, 0.25, 100)
