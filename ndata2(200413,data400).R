...
for (i in 1:2000){
  ...
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 0, 0.5, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 1, 0.5, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 2, 0.5, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 3, 0.5, 100)
