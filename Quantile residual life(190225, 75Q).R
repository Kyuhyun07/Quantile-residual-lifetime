...
d.r.initial.1=(log(4)^(1/d.k))/d.exp.beta.initial.1
...
r.initial.1=(log(4))^(1/k)/exp.beta.initial.1
...
for (i in 1:2000){
  ...
  b0.crq[i]<-summary(crq.fit,tau=c(0.25,0.75))[2][[1]]$coefficient[1,1]
  b0.crq.sd[i]<-summary(crq.fit,tau=c(0.25,0.75))[2][[1]]$coefficient[1,4]
  b1.crq[i]<-summary(crq.fit,tau=c(0.25,0.75))[2][[1]]$coefficient[2,1]
  b1.crq.sd[i]<-summary(crq.fit,tau=c(0.25,0.75))[2][[1]]$coefficient[2,4]
  
  # Beta estimation method 2 : Our method
  n=nrow(a)
  w=a[,12]
  X=cbind(c(rep(1,nrow(a))),a[,6])
  G<-matrix(c(1/400,0,0,1/400),2,2)
  betastart<-c(1.61,1.61) # from table0
  ...
  if (is.fit$fvec<1e-5&is.fit$fvec>-1e-5){
    ...
    cover[i,8]=ind(1.61,is.fit$x[2]-1.96*b1se,is.fit$x[2]+1.96*b1se)
    } else {
      mb.varb0[i]=NA
      mb.varb1[i]=NA
      ismb.varb0[i]=NA
...
for (i in 1:2000){
  ...
  X=cbind(c(rep(1,nrow(a))),a[,6])
  G<-matrix(c(1/400,0,0,1/400),2,2)
  betastart<-c(1.41,1.77) # from table0
  is.fit<-nleqslv(betastart,objectF,control=list(ftol=1e-5))
  b0.is[i]<-is.fit$x[1]
  b1.is[i]<-is.fit$x[2]
  solbeta=is.fit$x
  ...
  if (is.fit$fvec<1e-5&is.fit$fvec>-1e-5){
    ...
    cover[i,6]=is.fit$x[2]
    cover[i,7]=is.fit$x[2]+1.96*b1se
    cover[i,8]=ind(1.77,is.fit$x[2]-1.96*b1se,is.fit$x[2]+1.96*b1se)
  } else {
    mb.varb0[i]=NA
    mb.varb1[i]=NA
    ismb.varb0[i]=NA
...
for (i in 1:2000){
  ...
  X=cbind(c(rep(1,nrow(a))),a[,6])
  G<-matrix(c(1/400,0,0,1/400),2,2)
  betastart<-c(1.22,1.92) # from table0
  is.fit<-nleqslv(betastart,objectF,control=list(ftol=1e-5))
  b0.is[i]<-is.fit$x[1]
  b1.is[i]<-is.fit$x[2]
  solbeta=is.fit$x
  ...
  if (is.fit$fvec<1e-5&is.fit$fvec>-1e-5){
    ...
    cover[i,6]=is.fit$x[2]
    cover[i,7]=is.fit$x[2]+1.96*b1se
    cover[i,8]=ind(1.92,is.fit$x[2]-1.96*b1se,is.fit$x[2]+1.96*b1se)
  } else {
    mb.varb0[i]=NA
    mb.varb1[i]=NA
    ismb.varb0[i]=NA
...
for (i in 1:2000){
  ...
  X=cbind(c(rep(1,nrow(a))),a[,6])
  G<-matrix(c(1/400,0,0,1/400),2,2)
  betastart<-c(1.04,2.06) # from table0
  is.fit<-nleqslv(betastart,objectF,control=list(ftol=1e-5))
  b0.is[i]<-is.fit$x[1]
  b1.is[i]<-is.fit$x[2]
  solbeta=is.fit$x
  ...
  if (is.fit$fvec<1e-5&is.fit$fvec>-1e-5){
    ...
    cover[i,6]=is.fit$x[2]
    cover[i,7]=is.fit$x[2]+1.96*b1se
    cover[i,8]=ind(2.06,is.fit$x[2]-1.96*b1se,is.fit$x[2]+1.96*b1se)
  } else {
    mb.varb0[i]=NA
    mb.varb1[i]=NA
    ismb.varb0[i]=NA
