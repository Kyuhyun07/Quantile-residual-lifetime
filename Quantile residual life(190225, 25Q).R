...
for (i in 1:2000){
  ...
  b0.crq[i]<-summary(crq.fit,tau=c(0.10,0.25))[2][[1]]$coefficient[1,1]
  b0.crq.sd[i]<-summary(crq.fit,tau=c(0.10,0.25))[2][[1]]$coefficient[1,4]
  b1.crq[i]<-summary(crq.fit,tau=c(0.10,0.25))[2][[1]]$coefficient[2,1]
  b1.crq.sd[i]<-summary(crq.fit,tau=c(0.10,0.25))[2][[1]]$coefficient[2,4]
