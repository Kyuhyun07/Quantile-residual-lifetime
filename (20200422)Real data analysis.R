...
# Mac
load("/Users/kyuhyunkim/Desktop/Q/Paper/4. Real data/Data/spec.RData")
# PC
# load("C:/Users/com/Desktop/???Ð¿?/1. ?Ú»? ?ï¿½ï¿½ï¿?/2. ?ï¿½ï¿½ï¿??Øº? (Quantile residual life)/4. Real data/spec.RData")
...
data_survTime = dummy[order(dummy$survTime),]
...
# load("C:/Users/com/Downloads/paperreal/data_survTime.RData")
...
for (t in 1:5){
  ...
  result.ismb0[[t]] = ismb.est(data_survTime$survTime, 12, covariate, data_survTime$event, 0, t*0.05 ,100)
  result.ismb1[[t]] = ismb.est(data_survTime$survTime, 12, covariate, data_survTime$event, 1, t*0.05 ,100)
  result.ismb2[[t]] = ismb.est(data_survTime$survTime, 12, covariate, data_survTime$event, 2, t*0.05 ,100)
}
result5 = cbind(result.ismb0[[1]],result.ismb1[[1]],result.ismb2[[1]])
result10 = cbind(result.ismb0[[2]],result.ismb1[[2]],result.ismb2[[2]])
result15 = cbind(result.ismb0[[3]],result.ismb1[[3]],result.ismb2[[3]])
result20 = cbind(result.ismb0[[4]],result.ismb1[[4]],result.ismb2[[4]])
result25 = cbind(result.ismb0[[5]],result.ismb1[[5]],result.ismb2[[5]])
