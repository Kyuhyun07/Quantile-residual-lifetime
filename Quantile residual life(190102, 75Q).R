...
#### Given information for quantile 75% ####
c.0=5000000
c.1=53.03
c.2=26.58
c.3=17.73
exp.beta.initial=5
k=2
r.initial=(log(4))^(1/k)/exp.beta.initial
true.b0t0=log(5)
true.b0t1=log((1/r.initial)*((log(4)+(r.initial*1)^k)^(1/k))-1)
true.b0t2=log((1/r.initial)*((log(4)+(r.initial*2)^k)^(1/k))-2)
true.b0t3=log((1/r.initial)*((log(4)+(r.initial*3)^k)^(1/k))-3)
...
objectF<-function(beta){
  beta<-as.matrix(beta)
  result=t(w*X)%*%(pnorm((a[,5]-X%*%beta)/sqrt(diag(X%*%G%*%t(X))))-0.25)
  print(result)
}
...
rev.objectF=function(beta){
  beta=as.matrix(beta)
  result=t(eta*w*X)%*%(pnorm((a[,5]-X%*%beta)/sqrt(diag(X%*%G%*%t(X))))-0.25)
}
...
for (i in 1:500){
  ...
  dummy0[i]<-summary(fit0,tau=c(0.25,0.75))[2][[1]]$coefficient[1,1]
  dummy0.sd[i]<-summary(fit0,tau=c(0.25,0.75))[2][[1]]$coefficient[1,4]
  dummy1[i]<-summary(fit0,tau=c(0.25,0.75))[2][[1]]$coefficient[2,1]
  dummy1.sd[i]<-summary(fit0,tau=c(0.25,0.75))[2][[1]]$coefficient[2,4]
}
...
for (i in 1:500){
  ...
  dummy0[i]<-summary(fit1,tau=c(0.25,0.75))[2][[1]]$coefficient[1,1]
  dummy0.sd[i]<-summary(fit1,tau=c(0.25,0.75))[2][[1]]$coefficient[1,4]  
  dummy1[i]<-summary(fit1,tau=c(0.25,0.75))[2][[1]]$coefficient[2,1]
  dummy1.sd[i]<-summary(fit1,tau=c(0.25,0.75))[2][[1]]$coefficient[2,4]
}
...
for (i in 1:500){
  ...
  dummy0[i]<-summary(fit2,tau=c(0.25,0.75))[2][[1]]$coefficient[1,1]
  dummy0.sd[i]<-summary(fit2,tau=c(0.25,0.75))[2][[1]]$coefficient[1,4]   
  dummy1[i]<-summary(fit2,tau=c(0.25,0.75))[2][[1]]$coefficient[2,1]
  dummy1.sd[i]<-summary(fit2,tau=c(0.25,0.75))[2][[1]]$coefficient[2,4]  
}
...
for (i in 1:500){
  ...
  dummy0[i]<-summary(fit3,tau=c(0.25,0.75))[2][[1]]$coefficient[1,1]
  dummy0.sd[i]<-summary(fit3,tau=c(0.25,0.75))[2][[1]]$coefficient[1,4]   
  dummy1[i]<-summary(fit3,tau=c(0.25,0.75))[2][[1]]$coefficient[2,1]
  dummy1.sd[i]<-summary(fit3,tau=c(0.25,0.75))[2][[1]]$coefficient[2,4]  
}
...
for (i in 1:500){
  ...
  fit1<-crq(Surv(sim1[,5],sim1[,7])~sim1[,6],method='Portnoy')
  dummy0[i]<-summary(fit1,tau=c(0.25,0.75))[2][[1]]$coefficient[1,1]
  dummy0.sd[i]<-summary(fit1,tau=c(00.25,0.75))[2][[1]]$coefficient[1,4]  
  dummy1[i]<-summary(fit1,tau=c(0.25,0.75))[2][[1]]$coefficient[2,1]
  dummy1.sd[i]<-summary(fit1,tau=c(0.25,0.75))[2][[1]]$coefficient[2,4]
}
