...
d.r.initial.1=(log(10/2.5)^(1/d.k))/d.exp.beta.initial.1
...
r.initial.1=(log(10/2.5))^(1/k)/exp.beta.initial.1
...
for (i in 1:2000){
  ...
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 0, 0.75, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 1, 0.75, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 2, 0.75, 100)
...
for (i in 1:2000){
  ...
  # Beta estimation method 3: ISMB
  tryCatch({
    ismb.fit = ismb.est(a[,3], 1, a[,4], a[,5], 3, 0.75, 100)
